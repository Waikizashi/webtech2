...
<head>
  ...
  <link rel="icon" href="/z2/frontend/assets/sapp.ico" type="image/x-icon">
...
<body>
  ...
  <body>
    ...
    switch ($path) {
      case '/parse-app/bachelors':
        require 'pages/bachelors/bachelors.php';
        break;
      case '/parse-app/timetable':
        require 'pages/timetable/timetable.php';
        break;
      default:
